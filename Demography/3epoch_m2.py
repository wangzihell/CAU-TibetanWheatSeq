...
def sec_contact_sym_mig_size(params, ns, pts):
    ...
    phi = dadi.Integration.two_pops(phi, xx, T1, 1, nu2a, m12=m1, m21=m1)

    phi = dadi.Integration.two_pops(phi, xx, T2, 1, nu2b, m12=m2, m21=m2)
...
if __name__ == '__main__':
    ...
    upper_bound = [10.0,10.0,10.0,10.0,10.0,10.0]
    ...
    with open("3epoch_m2_"+options.randn+".csv", 'a') as f:
        for p in popt:
