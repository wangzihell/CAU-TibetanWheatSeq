...
def sec_contact_sym_mig_size(params, ns, pts):
    ...
    phi = dadi.Integration.two_pops(phi, xx, T1, 1, nu2a, m12=0, m21=m)

    phi = dadi.Integration.two_pops(phi, xx, T2, 1, nu2b)
...
if __name__ == '__main__':
    ...
    with open("3epoch_m_single_"+options.randn+".csv", 'a') as f:
        for p in popt:
